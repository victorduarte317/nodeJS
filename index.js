...
consign().include('routes').include('utils').into(app) // o consign vai incluir todos os arquivos criados em routes na variavel app, fazendo com que não seja mais necessário dar require arquivo por arquivo
// agora ele passa o app pros outros arquivos, então ocorrerão mudanças lá também

    app.listen(4000, '127.0.0.1', ()=>{ // coloca a variável que recebeu o servidor vai ouvir a porta 3000 e receber o endereço IP do servidor
